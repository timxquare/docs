/* eslint-disable */
// Generated by Wrangler by running `wrangler types` (hash: bee0e5255092ab53b3f60fcbf0a2a332)
// Runtime types generated with workerd@1.20260706.1 2025-06-01 nodejs_compat
interface __BaseEnv_Env {
	ICEMAIL_API_BASE: "https://api.icemail.ai";
	MCP_OBJECT: DurableObjectNamespace<import("./src/index").IcemailMCP>;
}
declare namespace Cloudflare {
	interface GlobalProps {
		mainModule: typeof import("./src/index");
		durableNamespaces: "IcemailMCP";
	}
...
declare namespace NodeJS {
	interface ProcessEnv extends StringifyValues<Pick<Cloudflare.Env, "ICEMAIL_API_BASE">> {}
}
